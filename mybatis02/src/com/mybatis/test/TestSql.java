...
public class TestSql {
		...
		public void testBacth()  throws Exception{
			...
			try {
				...
				emps.add(new Employee(null, "AA", "aa@sina.com", "男"));
				emps.add(new Employee(null, "BB", "bb@sina.com", "男"));
				emps.add(new Employee(null, "CC", "cc@sina.com", "女"));
